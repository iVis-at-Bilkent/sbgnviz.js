...
var AuxiliaryUnit = function () {
};
elementUtilities.AuxiliaryUnit = AuxiliaryUnit;

// -------------- StateVariable -------------- //
/**
 * parent has to be a stateful EPN (complex, macromolecule or nucleic acide)
 */
var StateVariable = function (value, stateVariableDefinition, parent) {
    AuxiliaryUnit.call(this);
    this.value = value;
...
elementUtilities.StateVariable = StateVariable;
// -------------- END StateVariable -------------- //
...
elementUtilities.UnitOfInformation = UnitOfInformation;
...
elementUtilities.EntityType = EntityType;
// -------------- END EntityType -------------- //
...
elementUtilities.StateVariableDefinition = StateVariableDefinition;
