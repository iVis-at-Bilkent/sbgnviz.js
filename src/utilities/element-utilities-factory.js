  ...
  */
  ...
  elementUtilities.SBML.connectivityConstraints = {
    "consumption": {
      ...
      "and":                  {asSource: {},   asTarget: {isAllowed: true}},
      "or":                   {asSource: {},   asTarget: {isAllowed: true}},
      "not":                  {asSource: {},   asTarget: {isAllowed: true}},
    ...
    "production": {
      ...
      "omitted process":      {asSource: {isAllowed: true},   asTarget: {}},
      "uncertain process":    {asSource: {isAllowed: true},   asTarget: {}},
      "truncated process":    {asSource: {isAllowed: true},   asTarget: {}},
      "phenotype sbml":            {asSource: {},   asTarget: {isAllowed: true}},
      "association":          {asSource: {},   asTarget: {}},
      "dissociation":         {asSource: {isAllowed: true, maxEdge: 1, maxTotal: 1},   asTarget: {}},
      "and":                  {asSource: {},   asTarget: {}},
      "or":                   {asSource: {},   asTarget: {}},
      "not":                  {asSource: {},   asTarget: {}},
    ...
    "trigger": {
      ...
      "association":          {asSource: {},   asTarget: {}},
      "dissociation":         {asSource: {},   asTarget: {}},
      "and":                  {asSource: {isAllowed: true},   asTarget: {}},
      "or":                   {asSource: {isAllowed: true},   asTarget: {}},
      "not":                  {asSource: {isAllowed: true},   asTarget: {}},
  ...
  */
  ...
  elementUtilities.canHaveUnitOfInformation = function (ele) {
    ...
    if (sbgnclass == 'simple chemical'
            ...
            || sbgnclass == 'rna' ||  sbgnclass == 'rna multimer' 
            || sbgnclass == 'hypothetical rna' || sbgnclass == 'hypothetical rna multimer' 
            || sbgnclass == 'simple molecule' ||  sbgnclass == 'simple molecule multimer' 
            || sbgnclass == 'hypothetical simple molecule'  || sbgnclass == 'hypothetical simple molecule multimer' 
            || sbgnclass == 'unknown molecule' ||  sbgnclass == 'unknown molecule multimer' 
            || sbgnclass == 'hypothetical unknown molecule' ||  sbgnclass == 'hypothetical unknown molecule multimer' 
            || sbgnclass == 'phenotype sbml' ||  sbgnclass == 'phenotype sbml multimer'
