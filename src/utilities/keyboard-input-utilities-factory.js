...
module.exports = function (param) {
  ...
  function keyboardInputUtilities (param) {
    ...
    $(document).ready(function () {
      ...
      networkContainer.on('keydown', '.integer-input', function(e){
        var value = $(this).attr('value');
        return keyboardInputUtilities.isIntegerFieldInput(value, e);
      });

      networkContainer.on('keydown', '.float-input', function(e){
        var value = $(this).attr('value');
        return keyboardInputUtilities.isFloatFieldInput(value, e);
      });

      networkContainer.on('change', '.integer-input,.float-input', function(e){
